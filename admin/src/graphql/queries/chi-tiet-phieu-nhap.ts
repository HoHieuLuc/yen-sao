...
import {
    UpdateChiTietPhieuNhapVars, ChiTietPhieuNhapsBySanPhamID, ChiTietPhieuNhapsBySanPhamIDVars,
    AllChiTietPhieuNhaps, AllChiTietPhieuNhapsVars, CreateChiTietPhieuNhapVars
} from '../../types';
